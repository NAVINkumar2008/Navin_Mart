...
<c:set var="pageTitle" value="Secure Checkout — NavinMart" scope="request" />
            ...
            <div class="checkout-grid" style="display: grid; grid-template-columns: 1.4fr 1fr; gap: var(--space-8); align-items: start;">
                ...
                <div>
                    ...
                    <div class="card" style="padding: var(--space-6); margin-bottom: var(--space-6);">
                        ...
                        <form id="checkoutForm" action="${pageContext.request.contextPath}/orders" method="POST" onsubmit="NavinMart.showFormLoading(this)">
