...
<c:set var="pageTitle" value="${product.name} — NavinMart" scope="request" />
        ...
        <c:choose>
            <c:when test="${not empty sessionScope.currentUser}">
                <div class="card" style="padding: var(--space-6); margin-bottom: var(--space-8); background-color: var(--bg-surface);">
                    ...
                    <form action="${pageContext.request.contextPath}/reviews" method="POST" class="form-review" onsubmit="NavinMart.showFormLoading(this)">
