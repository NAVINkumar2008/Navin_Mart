...
<c:set var="pageTitle" value="Create Account — NavinMart" scope="request" />
...
<div class="auth-wrapper" style="min-height: calc(100vh - 350px); display: flex; align-items: center; justify-content: center; padding: var(--space-8) var(--space-4);">
    <div class="card auth-card" style="width: 100%; max-width: 460px; padding: var(--space-8); box-shadow: var(--shadow-lg);">
        <div style="text-align: center; margin-bottom: var(--space-6);">
            ...
            <p style="font-size: 0.875rem; color: var(--text-muted); margin: 0;">Join NavinMart as a Discerning Buyer or Artisan Seller</p>
        </div>
        ...
        <form action="${pageContext.request.contextPath}/register" method="POST" class="form-auth" id="registerForm" onsubmit="NavinMart.showFormLoading(this)">
            ...
            <div class="form-group">
                ...
                <div style="position: relative; display: flex; align-items: center;">
                    ...
                    <button type="button" class="btn-text btn-password-toggle" onclick="NavinMart.togglePassword('password', this)" style="position: absolute; right: 4px; padding: 4px 8px; font-size: 0.75rem; color: var(--text-muted);" aria-label="Toggle password visibility">
                        Show
                    </button>
                </div>
            </div>
