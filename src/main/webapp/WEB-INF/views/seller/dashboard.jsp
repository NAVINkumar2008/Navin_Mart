...
<c:set var="pageTitle" value="Seller Hub — NavinMart" scope="request" />
...
<div class="container" style="padding-top: var(--space-6); padding-bottom: var(--space-12);">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--space-8); flex-wrap: wrap; gap: var(--space-4);">
        ...
        <button type="button" class="btn btn-primary" onclick="NavinMart.openModal('addProductModal')">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="empty-state">
                    ...
                    <button type="button" class="btn btn-primary" onclick="NavinMart.openModal('addProductModal')">&plus; Add First Creation</button>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
...
<div id="addProductModal" class="modal-backdrop">
    <div class="modal-dialog" style="max-width: 560px;">
        <div class="modal-header">
            ...
            <button type="button" class="modal-close" onclick="NavinMart.closeModal('addProductModal')">&times;</button>
        </div>
        <form action="${pageContext.request.contextPath}/seller/products" method="POST" onsubmit="NavinMart.showFormLoading(this)">
            <input type="hidden" name="_csrf" value="${csrfToken}">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="NavinMart.closeModal('addProductModal')">Cancel</button>
