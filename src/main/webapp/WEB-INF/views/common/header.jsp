...
<head>
    ...
    <title><c:out value="${pageTitle != null ? pageTitle : 'NavinMart — Curated Classical Marketplace'}" /></title>
    <meta name="description" content="NavinMart - Premium Multi-Seller Marketplace built on Java Servlets, H2, and Tomcat.">
...
<header class="site-header">
    <div class="container header-inner">
        <!-- Brand Logo -->
        <a href="${pageContext.request.contextPath}/home" class="brand-logo" aria-label="NavinMart Home">
            ...
            <span class="brand-name">Navin<span>Mart</span></span>
        </a>
