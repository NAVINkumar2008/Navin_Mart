/**
 * ==========================================================================
 * NavinMart - Classical & Lightweight Client-side Framework
...
const NavinMart = {
    ...
    initQuickAddToCart: function () {
        document.addEventListener("submit", async function (e) {
            ...
            const csrf = NavinMart.getCsrfToken();
            ...
            try {
                ...
                const response = await fetch(NavinMart.contextPath + "/api/cart/add", {
                    method: "POST",
                    headers: headers,
                ...
                if (response.ok && data.success) {
                    ...
                    NavinMart.refreshCartBadge();
                } else if (response.status === 401) {
                    Toast.info("Please sign in to manage your shopping cart");
                    setTimeout(() => {
                        window.location.href = NavinMart.contextPath + "/login?redirect=" + encodeURIComponent(window.location.pathname + window.location.search);
                    }, 1200);
                } else {
    ...
    initCartActions: function () {
        ...
        document.addEventListener("change", async function (e) {
            ...
            try {
                ...
                const res = await fetch(NavinMart.contextPath + "/api/cart/update", {
                    method: "POST",
                    headers: headers,
            ...
            Modal.confirm({
                ...
                onConfirm: async function () {
                    try {
                        ...
                        const res = await fetch(NavinMart.contextPath + "/api/cart/remove", {
                            method: "POST",
                            headers: headers,
